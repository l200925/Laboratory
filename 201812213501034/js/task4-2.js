...
// 
    var xMove = document.getElementById("xx");
    xMove.onchange = function(){
        move[0] = xMove.value/100;
    }
    var yMove = document.getElementById("yy");
    yMove.onchange = function(){
        move[1] = yMove.value/100;
    }
    var zMove = document.getElementById("zz");
    zMove.onchange = function(){
        move[2] = zMove.value/100;
    }
//
    render();
}
