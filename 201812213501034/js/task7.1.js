...
var color1 = new Uint8Array( [ 0, 0, 200, 255 ] );
var color2 = new Uint8Array( [ 0, 255, 100, 255 ] );
var color3 = new Uint8Array( [ 255, 110, 255, 255 ] );
var color4 = new Uint8Array( [ 10, 255, 255, 255 ] );
var color5 = new Uint8Array( [ 32, 0, 235, 255 ] );
var color6 = new Uint8Array( [ 55, 45, 0, 255 ] );
...
function configureCubeMap(){
	...
	gl.texImage2D( gl.TEXTURE_CUBE_MAP_POSITIVE_Z, 0, gl.RGBA, 1, 1, 0, gl.RGBA, gl.UNSIGNED_BYTE, color6 );
	gl.texImage2D( gl.TEXTURE_CUBE_MAP_NEGATIVE_Z, 0, gl.RGBA, 1, 1, 0, gl.RGBA, gl.UNSIGNED_BYTE, color5 );
